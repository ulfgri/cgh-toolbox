function [norm] = zern_norm(n,m)
% function [norm] = zern_norm(n,m)
%
% Calculate the ANSI Z80.28 normalization factor of a specified
% Zernike term
%
% vNorm : normalization factor
%
%   vNorm = inverse standard deviation wavefront for n > 0
%   vNorm = 1 for n == 0
%
% n     : radial order
% m     : angular order (frequency)
